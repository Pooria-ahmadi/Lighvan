  ...
  data() {
    return {
      ...
      cards: [
        ...
        { title: 'پنیر 400 گرمی شیور', content: ' پنیر صبحانه شیور با اصالت فرانسوی خود، بخشی از فرهنگ غذایی این کشور است و به دلیل ویژگی‌های مغذی و طعم ملایم، در سراسر جهان محبوب شده است.', image: '3.jpg',  price: '۱۹۸،۵۰۰'  },
        { title: 'پنیر 800 گرمی شیور', content: ' پنیر صبحانه شیور با اصالت فرانسوی خود، بخشی از فرهنگ غذایی این کشور است و به دلیل ویژگی‌های مغذی و طعم ملایم، در سراسر جهان محبوب شده است.', image: '3.jpg', price: '۳۴۸،۵۰۰'},
      ]
    }
  },
  methods: {
